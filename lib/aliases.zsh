...
alias webstop='launchctl unload -w /System/Library/LaunchDaemons/org.apache.httpd.plist; launchctl unload ~/Library/LaunchAgents/homebrew.mxcl.mysql.plist'
